...
class SharedPreferencesConst {
    companion object {
        ...
        const val CAPTURE_COUNT = "tts_count"

        const val IS_DOWNLOAD_TRANSLATOR_EN = "is_download_translator_en"
        const val IS_DOWNLOAD_TRANSLATOR_JP = "is_download_translator_jp"
        const val IS_DOWNLOAD_TRANSLATOR_KR = "is_download_translator_kr"
